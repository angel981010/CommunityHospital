...
#define API_ROOT_HOST @"http://101.200.73.189/build.json"
//wangyao0929
...
#define API_UPLOAD_HOST @"/sqHospital/upload_topic_pic.php"//上传图片的地址
#define API_PORTRAIT_UPLOAD @"/sqHospital/upload.php"   //头像上传目标文件夹
