...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row == 0) {
        ...
        return self.SISNameTVCell.frame.size.height+30;
//        return 30;
    }else if (indexPath.row == 2){
...
////        [self.SISuggestImageTVCell setSelectionStyle:UITableViewCellSelectionStyleNone];
//        [self.navigationController pushViewController:SSIVC animated:YES];
        ViewController4Food *VC4Food = [ViewController4Food createFromStoryboardName:@"CollectionView4Food" withIdentifier:@"CollectionView4Food"];
        [VC4Food getShopID:self.shop_user_info.shop_user_id];
        [VC4Food getShopName:self.shop_user_info.shop_user_name];
        [VC4Food getShopIcon:self.shop_user_info.shop_photo];
        
        [VC4Food getEstimateNum:self.shop_user_info.estimate_num];
        [VC4Food getShopPhone:self.shop_user_info.shop_phone];
        [VC4Food getShopNotice:self.shop_user_info.shop_notice];
        VC4Food.shop_phone = self.shop_user_info.shop_phone;

        [VC4Food ifNeedRecommendCommodity:true];
        [self.navigationController pushViewController:VC4Food animated:YES];
