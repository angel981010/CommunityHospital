...
- (void)viewDidLoad {
    ...
    [manager GET:API_ROOT_HOST parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        NSString *str = [NSString stringWithFormat:@"%@",responseObject[@"com.communityserviceHospital"]];
        myDelegate.address = [NSString stringWithFormat:@"%@",responseObject[@"com.communityserviceHospital"]];
